...
namespace MarketPal
{
    public partial class detalles_categoria : Form
    {
        ...
        public void ConfigurarDatosCategoria(string id, string nombre, string unidad, Dictionary<string, (string abreviatura, bool aceptaDecimales)> unidades, IFirebaseClient client)
        {
        ...
        private async void MostrarDetallesSubcategorias()
        {
            int numeroSubcategorias = await ContarSubcategorias();
            label_numero_subcategorias.Text = $"Número de subcategorías asociadas: {numeroSubcategorias}";
        }
